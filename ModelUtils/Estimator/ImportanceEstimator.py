...
class ImportanceEstimator(Estimator):
    def loss(self, x, h, q=None):
        ...
        # Remove the maximum entry to avoid numeric overflow
        ...
        # N
        element_loss = tf.check_numerics(target_scores, message="Target score ") - tf.check_numerics(tf.log(
            tf.check_numerics(self.Z_, message="The Z")), message="log Z")
